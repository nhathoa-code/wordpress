...
<main id="primary" class="site-main">
    <div class="policies__header" style="background:url('<?php echo wp_get_attachment_url(444,'full'); ?>') 50% / cover no-repeat">
        <div class="container">
            <div class="row">
            <div class="col-md-12"><h1>Đặc trưng</h1></div>
            </div>
        </div>
    </div>
    <?php
    ...
    <div class="feature__characteristic">
        <div class="container">
            ...
            <div class="col-md-12">
                ...
                <h2>8 Điểm đặc trưng của Khách sạn VNH</h2>
                </div>
                ...
                <p class="highlight__text">
                    ...
                    Minh. Chúng tôi mang đến cho khách hàng 8 dịch vụ đặc trưng với chất
    ...
    <?php
        get_template_part( 'template-parts/content-feature', 'list');
    ?>
</main>   
<?php
get_footer();